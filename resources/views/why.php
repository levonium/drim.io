...
<section id="why" class="full-section bg-violet-50 text-slate-900">
    <div class="py-24 px-3 sm:px-0">
        <h3 class="mb-16 text-2xl lg:text-5xl font-heading font-bold tracking-tight">
            ...
            <span class="block pt-4 text-slate-500 text-2xl font-light">
                some of the reasons why my clients love working with me
            </span>
        </h3>
        ...
        <div class="lg:flex lg:items-center lg:justify-end">
                            ...
                            <g clip-path="url(#:imageclip)" class="group">
                                <g class="origin-center scale-100 transition duration-500 motion-safe:group-hover:scale-105">
                                    <foreignObject width="655" height="680">
                                        <img alt="acuila.io-services" loading="lazy" width="358" height="512" decoding="async" class="w-full bg-slate-100 object-cover"
                                            style="color:transparent; aspect-ratio:3/4"
                                            srcset="/assets/images/laptop.jpg"
            ...
            <ul role="list" class="text-base text-slate-600 mt-16 lg:mt-0 lg:w-1/2 lg:min-w-[33rem] px-3 lg:pr-0 lg:pl-4">
                <?php foreach (reasons() as $key => $reason) { ?>
                    <li class="group mt-10 first:mt-0 appear appeared" data-period="360">
                        <div>
                            <div class="pt-10 group-first:pt-0 group-first:before:hidden group-first:after:hidden relative before:absolute after:absolute before:bg-slate-950 after:bg-slate-950/10 before:left-0 before:top-0 before:h-px before:w-6 after:left-8 after:right-0 after:top-0 after:h-px">
                                <strong class="font-semibold text-slate-950"><?php echo $reason; ?>.</strong>

                                <div class="inline *:first:inline">
